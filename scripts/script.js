...
//These are responses for correct and incorrect answers
...
const checkAnswer = function (correctHexCode) {
    $(".question .option").bind("click", function () {
        ...
        if ($(this).data("id") === correctHexCode) {
            ...
            // $(`*[data-id='${correctHexCode}']`).css("border", "5px solid green");
            // console.log(`.option[data-id='${correctHexCode}']`);
        }
...
const eventHandler = function(){
    ...
    $("button.splash").on("click", function(){
        // Add an animation to the H1 so it transitions out in a cool way.
        console.log("CLICKED!")
...
//When the user clicks on one, the correct one should get a green outline and if you clicked the wrong one, it should get a red outline and the correct should get a green outline.
